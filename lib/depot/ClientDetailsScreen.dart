...
class ClientDetailsScreen extends StatefulWidget {
  ...
  @override
  State<ClientDetailsScreen> createState() => _ClientDetailsScreen1State();
}

class _ClientDetailsScreen1State extends State<ClientDetailsScreen>
          ...
          children: [
            ...
            StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                double credit = 0;
                if (clientData['depot'] != null) {
                  credit = double.tryParse(clientData['depot'].toString()) ?? 0;
                }
                            ...
                            _buildAnimatedButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) => EditCreaditPagedepot(
