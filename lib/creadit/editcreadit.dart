...
class EditCreaditPage extends StatefulWidget {
  final String docId;
  final String oldName;
  final String oldCredit;
  final String oldPhone;
  final String oldLocation;

  const EditCreaditPage({
    Key? key,
    required this.docId,
...
class _EditCreaditPageState extends State<EditCreaditPage>
  ...
  void initState() {
    ...
    creditController = TextEditingController(text: widget.oldCredit);
