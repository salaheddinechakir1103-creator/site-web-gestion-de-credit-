    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await clientDoc.update({
          'credit': FieldValue.increment(isDeposit ? amount : -amount),
        });
                  ...
                  children: [
                    ...
                    StreamBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        double total = (data['credit'] ?? 0).toDouble();
                        currentCredit = total;
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => ClientDetailsScreen1(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              double amount = (depot['amount'] ?? 0).toDouble();
                              String detail = depot['detailcredit'] ?? '';
                              String date = depot['timestamp'] != null
                                  ? DateFormat('yyyy-MM-dd HH:mm').format(
                                      (depot['timestamp'] as Timestamp)
                                          .toDate(),
                                    )
                                  : '';
