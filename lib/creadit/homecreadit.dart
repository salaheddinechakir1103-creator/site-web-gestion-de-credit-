import 'package:Chakir_Shop/creadit/ajouterclient.dart';
import 'package:Chakir_Shop/creadit/editcreadit.dart';
import 'package:Chakir_Shop/creadit/homeclient.dart';
...
class HomeCreadit extends StatefulWidget {
  const HomeCreadit({super.key});

  @override
  State<HomeCreadit> createState() => _HomeCreaditState();
}

class _HomeCreaditState extends State<HomeCreadit>
          ...
          child: FloatingActionButton.extended(
            ...
            onPressed: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (_) => const InputScreen(docoss: ''),
                ),
              );
            },
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return AdvancedClientCard(
                            ...
                            onTap: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => ClientCreditsScreen(
                                    docId: doc.id,
                                    docoss: '',
                                  ),
                                ),
                            ...
                            onLongPress: () {
                              AwesomeDialog(
                                ...
                                btnOkOnPress: () {
                                  Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (context) => EditCreaditPage(
                                        docId: doc.id,
                                        oldName: name,
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          ...
                          Colors.deepPurple.shade500.withOpacity(0.8),
